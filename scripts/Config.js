Config = {
    ...
    DISABLED_TOKENS: ['BTC', 'LTC', 'STEEM', 'SBD', 'HIVE', 'HBD', 'BCC', 'XAP', 'XRP', 'GOLOS', 'DISNEY', 'AMAZON', 'VOICE', 'ETH', 'EOS', 'TIME', 'DONE', 'BNB', 'LASSE', 'R', 'SCTR', 'ALLAH', 'ETHER', 'LTCPEG', 'SBC', 'TEST.EON', 'BEEHIVE', 'BEECASH', 'SPL.FUND', 'ATOM.TOKEN', 'DSWAP', 'LEOG', 'PAKCOIN'],
    ...
    PEGGED_TOKENS: [{
        ...
        },
        {
            ...
            symbol: 'HBD',
            pegged_token_symbol: 'SWAP.HBD'
        },
        {
            name: 'Steem',
            symbol: 'STEEM',
            pegged_token_symbol: 'SWAP.STEEM'
        },
        {
        ...
        {
            name: 'Golos Classic',
            symbol: 'GOLOS CLASSIC',
            pegged_token_symbol: 'SWAP.GOLOS'
        },
        {
            name: 'SWIFT',
            symbol: 'SWIFT',
            pegged_token_symbol: 'SWAP.SWIFT'
        },
        {
            name: 'BitShares',
            symbol: 'BTS',
            pegged_token_symbol: 'SWAP.BTS'
        },
        {
            name: 'Bitcoin Cash',
            symbol: 'BCH',
            pegged_token_symbol: 'SWAP.BCH'
        },
        {
            name: 'Dogecoin',
            symbol: 'DOGE',
